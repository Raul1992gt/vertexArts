    ...
    <section className={styles.about}>
      ...
      <div className={styles.row}>
        <div className={styles.imageContainer}>
          <Image src="/vertexArt/images/nosotros.webp" alt="Taller VertexArt" width={400} height={250} className={styles.bnw} />
        </div>
      ...
      <div className={styles.row}>
        <div className={styles.imageContainer}>
          <Image src="/vertexArt/images/about.webp" alt="Creando arte" width={400} height={250} className={styles.bnw} />
        </div>
        <div className={styles.textContainer}>
