      ...
      <div className={styles.aboutContainer}>
        ...
        <button className={styles.accordion} onClick={() => togglePanel(1)}>
          ...
          <div className={`${styles.panel} ${active === 1 ? styles.show : ''}`}>
            <p>
              En Project Art, cada uno de nuestros proyectos refleja el compromiso y la pasión que ponemos en nuestro trabajo. Creemos que el éxito se construye con esfuerzo, y por eso, trabajamos arduamente en cada detalle, desde la concepción del diseño hasta el acabado final.
              ...
              El acabado final es donde nuestro trabajo duro y dedicación se hacen visibles. Nos aseguramos de que cada superficie, cada textura y cada detalle refleje la excelencia que define a Project Art, creando resultados que no solo satisfacen, sino que inspiran.
            </p>
          </div>
          ...
          <div className={`${styles.panel} ${active === 0 ? styles.show : ''}`}>
            <p>
              En Project Art, nuestro compromiso con el cliente y la sostenibilidad está en el centro de todo lo que hacemos. Creemos en construir relaciones basadas en la confianza, la transparencia y la atención personalizada, asegurándonos de que cada proyecto refleje tus necesidades, estilo y visión.
              ...
              Además, estamos profundamente comprometidos con la sostenibilidad. Utilizamos materiales reciclados como madera y hierro, y apostamos por procesos responsables que minimicen nuestro impacto ambiental. Al elegir Project Art, no solo estás adquiriendo piezas únicas y duraderas, sino que también estás contribuyendo a un futuro más sostenible.
              Nuestra misión es ofrecer productos que no solo embellezcan tus espacios, sino que también respeten el planeta y reflejen el valor de un trabajo ético y consciente. En Project Art, diseñamos con propósito, creamos con pasión y siempre ponemos a nuestros clientes y al medio ambiente en primer lugar.
            </p>
          </div>
          ...
          <div className={`${styles.panel} ${active === 2 ? styles.show : ''}`}>
            <p>
              En Project Art, creemos que cada proyecto es una oportunidad para crear algo verdaderamente único. Nos especializamos en ofrecer personalizaciones a medida, asegurándonos de que cada pieza que fabricamos refleje la personalidad y las necesidades específicas de nuestros clientes.
              ...
              Nuestro enfoque artesanal y nuestra pasión por el diseño nos permiten crear piezas irrepetibles. Cada proyecto se convierte en una obra de arte que combina creatividad, innovación y técnica. Desde diseños minimalistas y modernos hasta propuestas más audaces y artísticas, en Project Art todo está pensado para destacar.
              Con un compromiso inquebrantable con la calidad y la originalidad, nos aseguramos de que cada cliente reciba un producto único que transforme sus espacios en algo especial. En Project Art, no solo creamos productos; diseñamos experiencias que perduran.
            </p>
          </div>
          ...
          <div className={`${styles.panel} ${active === 3 ? styles.show : ''}`}>
            <p>
              ...
              Nuestra exclusividad no solo está en el diseño, sino en los valores que lo sostienen: sostenibilidad, innovación y compromiso con el detalle. Cuando eliges Project Art, eliges distinción con propósito.
            </p>
          </div>
        </div>
      </div>
